    ...
    <div class="container">
        <div class="focus-grids">
            <div class="col-md-3 focus-grid wow fadeInDown animated" data-wow-delay=".5s">
                <h3><%=list.get(i).getEqu_name()%></h3>
                <p><%=list.get(i).getEqu_type()%></p>
                <p><%=list.get(i).getEqu_explain()%></p>
            </div>
            <div class="col-md-3 focus-grid wow fadeInDown animated" data-wow-delay=".5s">
-
                <img src="<%=list.get(i).getEqu_picpath()%>"style="width: 300px;height:250px">

            </div>
            <div class="col-md-4 focus-grid wow fadeInDown animated" data-wow-delay=".5s">

                <img src="<%=list.get(i+1).getEqu_picpath()%>"style="width: 300px;height:250px">

            </div>
            <div class="col-md-2 focus-grid wow fadeInDown animated" data-wow-delay=".5s">
                <h3><%=list.get(i+1).getEqu_name()%></h3>
                <p><%=list.get(i+1).getEqu_type()%></p>
                <p><%=list.get(i+1).getEqu_explain()%></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
